...
DATA_DIR="$MODEL_TRAINING_ROOT/datasets/casual/casual-alpha-7-continuation-money-time-coverage"
ADAPTER_DIR="$MODEL_TRAINING_ROOT/artifacts/archive/casual/casual-lora-alpha-7/adapters/casual-alpha-7"
OUTPUT_DIR="$MODEL_TRAINING_ROOT/artifacts/archive/casual/casual-lora-alpha-7/outputs/casual-alpha-7"
RESUME_ADAPTER_FILE="${KEYVOX_RESUME_ADAPTER_FILE:-$MODEL_TRAINING_ROOT/artifacts/archive/casual/casual-lora-alpha-6/adapters/casual-alpha-6/adapters.safetensors}"
...
echo "Training Casual alpha-7 adapter..."
TRAIN_ARGS=(
    --model "$MODEL" \
    --train \
    --data "$DATA_DIR" \
