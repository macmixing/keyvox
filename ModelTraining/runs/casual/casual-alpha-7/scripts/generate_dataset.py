...
def main() -> int:
    ...
    manifest = {
        "version": "casual-alpha-7",
        "purpose": "continuation from casual-alpha-6 for broader money plus time boundary coverage across contrast and plain start-time phrasing",
