...
ADAPTER_DIR="$MODEL_TRAINING_ROOT/artifacts/archive/polished-lora-alpha-010/adapters/polished-alpha-010"
OUTPUT_DIR="$MODEL_TRAINING_ROOT/artifacts/archive/polished-lora-alpha-010/outputs/polished-alpha-010"
...
echo "Training Polished alpha-010 adapter..."
run_lora \
    --model "$MODEL" \
    --train \
    --data "$DATA_DIR" \
