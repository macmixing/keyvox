...
DATA_DIR="$MODEL_TRAINING_ROOT/datasets/polished/alpha-020-continuation-paragraph-meaning"
ADAPTER_DIR="$MODEL_TRAINING_ROOT/artifacts/archive/polished-lora-alpha-020/adapters/polished-alpha-020"
OUTPUT_DIR="$MODEL_TRAINING_ROOT/artifacts/archive/polished-lora-alpha-020/outputs/polished-alpha-020"
RESUME_ADAPTER_FILE="${KEYVOX_RESUME_ADAPTER_FILE:-$MODEL_TRAINING_ROOT/artifacts/archive/polished-lora-alpha-019/adapters/polished-alpha-019/adapters.safetensors}"
...
echo "Training Polished alpha-020 adapter..."
TRAIN_ARGS=(
    --model "$MODEL" \
    --train \
    --data "$DATA_DIR" \
