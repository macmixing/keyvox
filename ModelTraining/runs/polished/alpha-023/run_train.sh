...
DATA_DIR="$MODEL_TRAINING_ROOT/datasets/polished/alpha-023-continuation-spoken-years"
ADAPTER_DIR="$MODEL_TRAINING_ROOT/artifacts/current/polished-lora-alpha-023/adapters/polished-alpha-023"
OUTPUT_DIR="$MODEL_TRAINING_ROOT/artifacts/current/polished-lora-alpha-023/outputs/polished-alpha-023"
...
echo "Training Polished alpha-023 adapter..."
TRAIN_ARGS=(
    --model "$MODEL" \
    --train \
    --data "$DATA_DIR" \
