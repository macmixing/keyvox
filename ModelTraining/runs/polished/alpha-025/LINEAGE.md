# Polished Alpha-025 Lineage

## Candidate Adapter

`polished-alpha-025` is a candidate continuation for the Polished vibe. It addresses money/quantity boundary regressions observed in live inference after alpha-024, including adjacent dollar amounts and day counts, price ratios, star rating counts, and math expressions with money operands.
...
9. `polished-alpha-025`
   - Run: `ModelTraining/runs/polished/alpha-025`
   - Dataset: `ModelTraining/datasets/polished/alpha-025-continuation-money-boundaries`
   - Continued from: `ModelTraining/artifacts/current/polished-lora-alpha-024/adapters/polished-alpha-024/adapters.safetensors`
   - Final MLX adapter checkpoint: `ModelTraining/artifacts/current/polished-lora-alpha-025/adapters/polished-alpha-025/adapters.safetensors`
   - Runtime GGUF: `ModelTraining/artifacts/current/polished-lora-alpha-025/adapters/polished-alpha-025/polished-alpha-025-lora.gguf`
