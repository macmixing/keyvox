...
DATA_DIR="$MODEL_TRAINING_ROOT/datasets/polished/rejected/alpha-018-continuation-paragraphs"
ADAPTER_DIR="$MODEL_TRAINING_ROOT/artifacts/rejected/polished-lora-alpha-018/adapters/polished-alpha-018"
OUTPUT_DIR="$MODEL_TRAINING_ROOT/artifacts/rejected/polished-lora-alpha-018/outputs/polished-alpha-018"
RESUME_ADAPTER_FILE="${KEYVOX_RESUME_ADAPTER_FILE:-$MODEL_TRAINING_ROOT/artifacts/archive/polished-lora-alpha-017/adapters/polished-alpha-017/adapters.safetensors}"
...
echo "Training Polished alpha-018 adapter..."
TRAIN_ARGS=(
    --model "$MODEL" \
    --train \
    --data "$DATA_DIR" \
