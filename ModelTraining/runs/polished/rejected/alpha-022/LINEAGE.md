# Polished Alpha-022 Lineage

## Rejected Adapter

`polished-alpha-022` was canceled before training because the target case did not match real post-processed dictation input.
...
7. `polished-alpha-022`
   - Run: `ModelTraining/runs/polished/rejected/alpha-022`
   ...
   - Adapter artifacts: not generated
