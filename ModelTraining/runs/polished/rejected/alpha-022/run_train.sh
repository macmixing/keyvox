...
ADAPTER_DIR="$MODEL_TRAINING_ROOT/artifacts/rejected/polished-lora-alpha-022/adapters/polished-alpha-022"
OUTPUT_DIR="$MODEL_TRAINING_ROOT/artifacts/rejected/polished-lora-alpha-022/outputs/polished-alpha-022"
RESUME_ADAPTER_FILE="${KEYVOX_RESUME_ADAPTER_FILE:-$MODEL_TRAINING_ROOT/artifacts/current/polished-lora-alpha-021/adapters/polished-alpha-021/adapters.safetensors}"
...
echo "Training Polished alpha-022 adapter..."
TRAIN_ARGS=(
    --model "$MODEL" \
    --train \
    --data "$DATA_DIR" \
