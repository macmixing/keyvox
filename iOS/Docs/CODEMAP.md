...
- `KeyVox iOS/Core/LocalRewriteModel/LocalRewriteModelCatalog.swift`
  ...
  - Current bundled adapters are provided by `KeyVoxVibesAdapters`: `polished-alpha-025-lora.gguf` and `casual-alpha-8-lora.gguf`.
