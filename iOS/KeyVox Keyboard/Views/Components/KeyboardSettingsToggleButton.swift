...
final class KeyboardSettingsToggleButton: UIControl {
    ...
    private func colorsForState(isPressed: Bool, isEnabled: Bool) -> (fill: UIColor, border: UIColor, foreground: UIColor) {
        ...
        if isPressed {
            return (
                ...
                foreground: isOn ? pressedActiveForegroundColor() : KeyboardStyle.keyLabelColor
            )
        }
        ...
        return (
            ...
            foreground: isOn ? activeForegroundColor() : KeyboardStyle.keyLabelColor
        )
    }
