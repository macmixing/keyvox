...
@MainActor
final class iOSWeeklyWordStatsCloudSync {
    ...
    private func push(snapshot: WeeklyWordStatsPayload) {
        do {
            ...
            print("[iOSWeeklyWordStatsCloudSync] Failed to encode weekly word stats payload: \(error)")
        }
    }
    ...
    private func loadRemoteSnapshot() -> WeeklyWordStatsPayload? {
        ...
        do {
            ...
            print("[iOSWeeklyWordStatsCloudSync] Failed to decode weekly word stats payload: \(error)")
            return nil
        }
    }
}
