...
extension iOSTranscriptionManager {
    ...
    func stageInterruptedCaptureIfNeeded(_ stoppedCapture: iOSStoppedCapture) {
    ...
    private func interruptedCaptureRecoveryPayload(for stoppedCapture: iOSStoppedCapture) -> iOSInterruptedCaptureRecoveryPayload? {
        ...
        return iOSInterruptedCaptureRecoveryPayload(
            recovery: iOSInterruptedCaptureRecovery(
                capturedAt: Date(),
