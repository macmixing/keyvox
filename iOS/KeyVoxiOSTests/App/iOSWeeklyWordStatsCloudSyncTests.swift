...
@MainActor
struct iOSWeeklyWordStatsCloudSyncTests {
    @Test func localSnapshotSeedsEmptyCloud() throws {
        ...
        let sync = iOSWeeklyWordStatsCloudSync(
    ...
    private func makeHarness(now: Date, initialNow: Date? = nil) -> WeeklySyncHarness {
        let suiteName = "iOSWeeklyWordStatsCloudSyncTests.\(UUID().uuidString)"
...
private final class InMemoryWeeklyWordStatsCloudStore: iOSiCloudKeyValueStoring {
