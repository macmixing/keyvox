...
struct MacLocalRewriteModelArtifact: Equatable, Sendable {
    let filename: String
    let remoteURL: URL
...
struct MacLocalRewriteModelDescriptor: Equatable, Sendable {
    let id: String
    let displayName: String
    let sourceRepository: String
    let artifact: MacLocalRewriteModelArtifact
}

enum MacLocalRewriteModelCatalog {
    ...
    static let descriptor = MacLocalRewriteModelDescriptor(
