...
- `Views/Settings/SettingsVibesCard.swift` is the release-facing Vibes AI settings surface for install, removal, progress, repair, and style selection.
