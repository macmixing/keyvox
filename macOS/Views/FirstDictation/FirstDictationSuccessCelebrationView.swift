...
struct FirstDictationSuccessCelebrationView: View {
    ...
    var body: some View {
        VStack(spacing: 18) {
            ...
            VStack(spacing: 8) {
                ...
                Text("KeyVox is ready whenever you are.")
    ...
    private func resetCelebration() {
        ...
        checkmarkTrim = 0
        contentOpacity = 0
        particleOffsets = Array(repeating: .zero, count: Metrics.particleCount)
        particleOpacities = Array(repeating: 0, count: Metrics.particleCount)
    }
}
